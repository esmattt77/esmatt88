...
$info["members"][$chat_id]["mode"] =   null;
 ...
 🛍 ⁞  مرحباً بك في *بوت حماده* ، البوت الأول على التليجرام والذي يقوم *بتوفِير خَدمات الأرقام الوهْمية* ل *مواقع التواصل الإِجتماعي* مثل *الواتساب والتيليجرام والفيسبوك وغيره.*
☑️ ⁞ مطور البوت : حماده @TTAVIP
...
sendd("-1002726185112","*☑️ - تم إنشاء حساب جديد في البوت.!🤖*
